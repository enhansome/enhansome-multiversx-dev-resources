# Awesome MultiversX Dev Resources with stars
...
* [Liquid Staking](https://github.com/multiversx/mx-liquid-staking-sc) ⭐ 6 | 🐛 1 | 🌐 Rust | 📅 2025-10-21
* [xExchange tools](https://github.com/multiversx/mx-exchange-tools-sc) ⭐ 5 | 🐛 8 | 🌐 Rust | 📅 2025-11-24 - Smart contracts on top of the xExchange functionality as extensions for better UX
* [Metabonding](https://github.com/multiversx/mx-metabonding-sc) ⭐ 1 | 🐛 4 | 🌐 Rust | 📅 2025-07-28
...
* [React Dapp SDK](https://github.com/multiversx/mx-sdk-dapp) ⭐ 84 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-14 - A library that holds the core functional logic of a dapp on the MultiversX
* [Javascript SDK](https://github.com/multiversx/mx-sdk-js-core) ⭐ 73 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-27 - Official TS/JS SDK for interacting with the MultiversX Network and MultiversX Smart Contracts using Javascript (written in Typescript)
* [Go SDK](https://github.com/multiversx/mx-sdk-go) ⭐ 17 | 🐛 13 | 🌐 Go | 📅 2025-10-17 - Go helpers and utilities for interacting with the MultiversX Blockchain
...
* [Dapp SC Explorer SDK](https://github.com/multiversx/mx-sdk-dapp-sc-explorer) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-05 - A library to hold the main logic for Smart Contract Interactions on the MultiversX blockchain
...
* [MultiversX dApp template](https://github.com/multiversx/mx-template-dapp) ⭐ 221 | 🐛 6 | 🌐 TypeScript | 📅 2026-07-16 - The official dApp template provided by the MultiversX team using React.js & Typescript. It's a basic implementation of [@multiversx/sdk-dapp](https://www.npmjs.com/package/@multiversx/sdk-dapp), providing the basics for MultiversX authentication and TX signing.
...
* [xExchange service](https://github.com/multiversx/mx-exchange-service) ⭐ 14 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-10 - Decentralized Exchange Service based on GraphQL
* [Trusted Co-Signer Service](https://github.com/multiversx/mx-multi-factor-auth-go-service) ⭐ 3 | 🐛 2 | 🌐 Go | 📅 2025-07-17 - It is the component that automates most of the Guardian processes and makes it easy for users to turn wallets into unbreakable vaults
...
* [Presale Smart Contract](https://github.com/xdevguild/elrond-pack-presale-sc) ⭐ 5 | 🐛 1 | 🌐 Rust | 📅 2022-05-22 - Token Presale with Packs. Each pack has given EGLD amount and bonus percentage for the presale token
* [Multi Sender smart contract](https://github.com/xdevguild/sc-multi-sender-rs) ⭐ 5 | 🐛 0 | 🌐 Shell | 📅 2022-08-19 - A multi-sender smart contract that allows you to send EGLD, ESDTs, and NFTs to multiple addresses in one transaction
* [Elven Tools SFT Minter Smart Contract](https://github.com/ElvenTools/elven-tools-sft-minter-sc) ⭐ 4 | 🐛 0 | 🌐 Rust | 📅 2024-04-18 - SFT minter and vending machine smart contract
* [NFTs based on inscriptions](https://github.com/XOXNO/rs-inscriptions) ⭐ 4 | 🐛 1 | 🌐 Rust | 📅 2024-01-14 - NFTs with data on-chain, thanks to inscriptions
* [ESDT Faucet SC](https://github.com/xdevguild/esdt-faucet-sc) ⭐ 3 | 🐛 0 | 🌐 Rust | 📅 2024-03-10 - ESDT Faucet - claim, deposit ESDT tokens
* [Fundraising-SC](https://github.com/Vital-Network/Fundraising-SC) ⭐ 3 | 🐛 0 | 🌐 Rust | 📅 2023-05-08 - MultiversX Fundraising Smart Contract allowing the creation of pots with or without objectives, with or without deadlines.
* [Vesting SC](https://github.com/Moonlorian/vesting-dapp/tree/main/sc) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2023-03-01 - Token vesting smart contract
* [Nifty Maze & Proxy Ping Smart Contracts](https://github.com/NiftyWell/nifty-maze/tree/main) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-11-17 - smart-contract-based mini-game
* [PublicFlashLoansSC](https://github.com/PierreBlg/PublicFlashLoansSC) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2023-11-15 - Flash Loans on top of MultiversX xExchange
...
* [xSuite](https://github.com/arda-org/xSuite) ⭐ 15 | 🐛 4 | 🌐 TypeScript | 📅 2025-07-21 - Init, Build, Test, Deploy MultiversX smart contracts in seconds. The full suite for efficiently developing high-quality contracts.
* [MultiversX Unity Tools](https://github.com/chainofindustry/MultiversXUnityTools) ⭐ 14 | 🐛 3 | 🌐 C# | 📅 2023-09-21 - A work-in-progress set of tools to interact with MultiversX Blockchain directly from a Unity app.
* [MultiversX SDK for Laravel](https://github.com/PeerMeHQ/mx-sdk-laravel) ⭐ 14 | 🐛 0 | 🌐 PHP | 📅 2025-05-05 - MultiversX SDK for Laravel (written in PHP)
* [xNetwork](https://github.com/gfusee/xnetwork) ⭐ 14 | 🐛 2 | 🌐 TypeScript | 📅 2024-03-15 - This project provides an easy way to run a local testnet of MultiversX and its associated API, with no configuration required
* [ABI2API](https://github.com/SkullElf/ABI2API) ⭐ 14 | 🐛 1 | 🌐 Python | 📅 2023-08-07 - ABI2API is a Python library for converting smart contract ABI (Application Binary Interface) on the MultiversX blockchain into a RESTful API
* [Spring Boot Starter Reactive](https://github.com/crldev-software/multiversx-spring-boot-starter-reactive) ⭐ 14 | 🐛 0 | 🌐 Java | 📅 2023-10-05 - Spring Boot Starter project for integrating with the MultiversX Network, with the goal of achieving an effortless autoconfigured integration with the network.
* [MultiversX API Deployer](https://github.com/PhyByte/mvx-api-deployer) ⭐ 14 | 🐛 12 | 🌐 Shell | 📅 2025-03-24 - Effortlessly deploy a complete infrastructure to run your own MultiversX API in just a few steps.
* [ESDT Distribution script](https://github.com/Combased/elrond-lkmex-distribution) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2022-08-21
...
* [Mx.NET.SDK](https://github.com/RemarkableTools/Mx.NET.SDK) ⭐ 6 | 🐛 0 | 🌐 C# | 📅 2024-12-16 - MultiversX .NET SDK: Complex library for interacting with MultiversX blockchain
* [Mx.Blazor.DApp](https://github.com/RemarkableTools/Mx.Blazor.DApp) ⭐ 6 | 🐛 0 | 🌐 C# | 📅 2026-03-29 - Blazor DApp is a template application built using the Blazor UI framework and ASP.NET Core server application
* [ABIExtractor](https://github.com/SkullElf/ABIExtractor) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2023-08-16 - ABI Extractor is a Python tool designed to extract ABI JSONs, and smart contract (SC) addresses from dApp JavaScript files.
* [LKMEX airdrop](https://github.com/xdevguild/esdt-and-lkmek-airdrop-scripts) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2025-03-21 - Python script that performs an airdrop of LKMEX to NFT holders
...
* [Vesting dApp](https://github.com/Moonlorian/vesting-dapp/tree/main/dapp) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2023-03-01 - Token vesting dApp
* [ESDT Faucet Dapp](https://github.com/xdevguild/esdt-faucet-dapp) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2024-03-10 - The ESDT tokens faucet app for the devnet/testnet
